...
describe('foreman', function () {
  ...
  describe('forkWorker()', function () {
    ...
    it('calls child_process.fork on the requested worker', function () {
      ...
      var workerPath = _path2.default.resolve(_path2.default.join(__dirname, 'workers', workerName + '/index.js'));
  ...
  describe('stateChanged()', function () {
    ...
    it('starts transpilation if that is the goal', function () {
      ...
      (0, _chai.expect)(sendSpy).to.be.calledWith((0, _state2.setGoal)(_foreman.GOAL_TRANSPILE));
    });
    ...
    it('starts linting if transpilation is done', function () {
      ...
      (0, _chai.expect)(sendSpy).to.be.calledWith((0, _state.setGoal)(_foreman.GOAL_LINT));
    });
  });
});
