...
var init = exports.init = (0, _utils.workerInit)(_state2.WORKER_LINTER, stateChanged);
...
function lint(store) {
  ...
  process.send((0, _state2.workerBusy)(_state2.WORKER_LINTER));
  ...
  process.send((0, _state2.workerReady)(_state2.WORKER_LINTER));
}
