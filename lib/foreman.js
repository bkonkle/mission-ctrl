    ...
    case _foreman.GOAL_TRANSPILE:
      switch (state.workers.getIn([workers.WORKER_TRANSPILER, 'status'])) {
        case workers.READY:
          ...
          processes[workers.WORKER_TRANSPILER].send((0, _transpiler.setGoal)(_foreman.GOAL_TRANSPILE));
          break;
        case workers.DONE:
    ...
    case _foreman.GOAL_LINT:
      switch (state.workers.getIn([workers.WORKER_LINTER, 'status'])) {
        case workers.READY:
          ...
          processes[workers.WORKER_LINTER].send((0, _linter.setGoal)(_foreman.GOAL_LINT));
          break;
        case workers.DONE:
          // Next!
          break;
